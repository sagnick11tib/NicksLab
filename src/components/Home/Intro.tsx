  ...
  return (
    <section className="mt-8 text-zinc-600 dark:text-zinc-400">
      <div className="space-y-5 text-left">
        <p>
          Hi, I&apos;m Sagnick Manna, a Full-Stack developer from India. I love
          to build SaaS products and web applications. I am currently learning{" "}
        ...
        <p>
          I am specialize in building web applications using MERN stack and have
          experience in building SaaS products.
        </p>
        <p>
          I truly enjoy building products that solve real-world problems. I am
          always looking for new challenges and opportunities to learn and grow.
        </p>
        <div className="flex">
          Current
          <a
            href="https://shop.nickslab.live"
            target="_blank"
            rel="noopener noreferrer"
            className="group ml-1 flex"
          >
            {" "}
            deployed&nbsp;<span className="wavvy">PROJECT</span>&nbsp;.
